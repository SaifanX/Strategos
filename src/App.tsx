...
const MultiplayerRoom = lazy(() => import('./pages/MultiplayerRoom').then(m => ({ default: m.MultiplayerRoom })));
      ...
      <AnimatePresence mode="wait">
        <Suspense fallback={
          <div className="h-screen w-full flex items-center justify-center bg-black">
            <div className="w-12 h-12 border-2 border-jet-orange/20 border-t-jet-orange animate-spin" />
          </div>
        }>
          <Routes location={location} key={location.pathname}>
            ...
            <Route path="/simulation" element={
              ...
              <section className="sr-only" aria-hidden="false">
                <h2>Conflict Engine: Evolutionary Simulation Environment</h2>
                <p>This interactive laboratory allows for real-time modeling of game theoretical 
                   dynamics. Parameters include population size, mutation rates, and survival 
                   thresholds. The simulation tracks the evolution of strategic behaviors 
                   like Tit-for-Tat and Pavlov across successive generations.</p>
              </section>
